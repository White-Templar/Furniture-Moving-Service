    ...
    final list = ListView(
      ...
      children: [
        ...
        Row(
          ...
          children: _categories.map((category) => Column(
            children: [
              Icon(category.icon),
              Text(category.name),
            ],
        ...
        Wrap(
          spacing: 8,
          runSpacing: 8,
          children: demoServices.map((service) => _buildServiceCard(service)).toList(),
        ),
        const SizedBox(height: 24),
    ...
    if (widget.cupertino) {
      return CupertinoPageScaffold(
        navigationBar: const CupertinoNavigationBar(
          middle: Text('Book Moving Service'),
        ),
        child: list,
      );
    }
    return Scaffold(
      appBar: AppBar(title: const Text('Book Moving Service')),
      body: list,
    );
  }
